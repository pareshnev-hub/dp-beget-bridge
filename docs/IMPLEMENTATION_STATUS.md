...
| R0002 Core Safety & Persistent Runtime | PLANNED | DP-001 is first; complete DP-001–DP-011 and R0002 gates |
...
|---|---:|---:|---:|---|---|
| DP-001 Prevent destructive move pre-delete | #1 | P0 | R0002 | PLANNED | FILE-01/02/03/09 |
| DP-002 Source-linked baseline and real runtime CI | #2 | P1 | R0002 | PLANNED | TERM-01/02/03 plus environment evidence |
