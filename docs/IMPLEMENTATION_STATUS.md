...
| R0002 Core Safety & Persistent Runtime | IN PROGRESS | DP-001, DP-002 and DP-004–DP-011 verified; DP-003 is implemented with real-client evidence pending; implementation queue complete, evaluate remaining release gates |
