...
| Local release and resource diagnostics | this change | Local doctor identifies a managed release version/commit, checks state schema version read-only and reports the disk reserve; signing and database integrity remain separate release gates |
