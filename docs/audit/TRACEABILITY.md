...
| F04 file input contract/descriptors | P1 | DP-003, DP-017 | target-client contract fixture, schema/output snapshots, annotation assertions, actual ChatGPT list/upload/download calls and the sanitized immediate tunnel-peer identity | R0002 |
